...
public class SaveTaskAppointorCommand implements Command<Object> {
	...
	public Object execute(Context context) {
		...
		var query=session.createQuery("delete "+TaskAppointor.class.getName()+" where taskNodeName=:nodeName and processInstanceId=:processInstanceId");
		query.setParameter("nodeName",taskNodeName)
			.setParameter("processInstanceId", task.getRootProcessInstanceId())
			.executeUpdate();
